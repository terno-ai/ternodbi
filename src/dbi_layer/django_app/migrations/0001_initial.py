            ...
            state_operations=[
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('datasources', models.ManyToManyField(blank=True, help_text='If empty, token has global access. Otherwise limited to these datasources.', related_name='service_tokens', to='django_app.datasource')),
                    ],
