...
MERGED_INSTRUCTIONS = (
    ...
    "To add a database, call connect_datasource and show the user the link it "
    "returns. Never ask for a connection string or password: the credential is "
    "entered in Terno so it never passes through this conversation.\n\n"
